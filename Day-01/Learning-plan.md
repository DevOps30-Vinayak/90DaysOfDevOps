...
- What is your understanding of DevOps and Cloud Engineering?
   ...
   As per my understanding, Devops and cloud Engineering is combination of Operation & support techniical role, who responsible for designing,integrating,developing,monitoring.
- Why you are starting learning DevOps & Cloud?
  
  I am curently working as Support Engineer role in IT field and i need move in Devops platform for growth and good career platform.
...
- Define **3 clear goals** for the next 90 days  
  1) Foucus on Daily Study 
  2) After 90 Days achive 1 Certification in DevOps and Cloud
  3) Transform Career into Devops Platform.
- Define **3 core DevOps skills** you want to build  
  1) Linux troubleshooting
  2) hands on practice on Tools like Git, Docker, CI/CD pipelines, Kubernetes debugging etc.
  3) Work and deplay projects
